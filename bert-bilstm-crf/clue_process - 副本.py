...
def _read_json(input_file, mode="train"):
    ...
    with open(f"./cluener_public/{mode}.txt", "w") as f:
        for line in lines:
...
if __name__ == "__main__":
    _read_json("./cluener_public/train.json", "train")
    _read_json("./cluener_public/dev.json", "dev")
    _read_json("./cluener_public/test.json", "test")
